...
import {
 ...
 import { fetchPresImages } from "../../store/GetPresImagesSlice";
...
const Prescription =() => {
    ...
    const PresImages=useSelector((state)=>state.getPresImages);    
    const Imagedata=PresImages.imagesArray;
